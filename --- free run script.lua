...
local function updatePosition()
    ...
    if FightKickFlag == true then
        ...
        if plrCharacter.Humanoid.MoveDirection.Magnitude > 0 then
            ...
            - plrCharacter.Humanoid.MoveDirection * (24 / 137) * (plrCharacter.Humanoid.WalkSpeed/10)
    ...
    elseif IsRunning() and plrCharacter.Humanoid.MoveDirection.Magnitude > 0 and plrCharacter.Blocking_Capacity.Value == 0 then
        if not isClimbing then
            plrCharacter.HumanoidRootPart.CFrame = plrCharacter.HumanoidRootPart.CFrame + plrCharacter.Humanoid.MoveDirection * (24 / 137) * ADDTORUNSPEED/10
        elseif UserInputService:IsKeyDown(Enum.KeyCode.W) then
            plrCharacter.HumanoidRootPart.CFrame = plrCharacter.HumanoidRootPart.CFrame + Vector3.new(0, (24 / 137) * ADDTORUNSPEED/10, 0)
